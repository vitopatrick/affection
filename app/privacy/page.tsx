...
export default function PrivacyPage() {
  return (
    <div className="w-11/12 mx-auto p-4 space-y-6 my-4">
      <h4 className="text-center text-2xl">PRIVACY POLICY</h4>
      <p className="text-center">
        Your privacy is important to us. It is Affections Arcade policy to
